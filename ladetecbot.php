...
function sqlite_open($location) {
    ...
    sqlite_query( $handle, 'CREATE table IF NOT EXIST temp (id varchar(20) primary key, assunto varchar (50), local text)');
    sqlite_query( $handle, 'CREATE table IF NOT EXIST ti (id int auto_increment primary key, chat varchar (20), nome varchar  (30) )');
    sqlite_query( $handle, 'CREATE table IF NOT EXIST chamados (id int auto_increment primary key, id_ti int, chat varchar (20), problema text )');
    return $handle;
}
